...
startup/startup_MKL25Z4.o: H:/KDS\ studio/platform/devices/MKL25Z4/startup/gcc/startup_MKL25Z4.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -Wall  -g -x assembler-with-cpp -DDEBUG -I"H:\KDS studio\examples\frdmkl25z\demo_apps\hello_world_1\kds\inc" -I"H:\KDS studio\examples\frdmkl25z\demo_apps\hello_world_1\kds\src" -fno-common  -ffunction-sections  -fdata-sections  -ffreestanding  -fno-builtin  -mapcs  -std=gnu99 -MMD -MP -MF"startup/startup_MKL25Z4.d" -MT"startup/startup_MKL25Z4.d" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
